...
<html>
    ...
    <body>
        ...
        <div id='calendario'><div id='calendar'></div></div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="conexao.php" id="addevent" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="color" class="form-control" id="color" readonly>		
                                        <option style="color:#006400;" value="#006400">Verde</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
